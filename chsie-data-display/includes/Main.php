...
class CHSIE_Data_Display {
    ...
    */
    private function define_admin_asset_hooks() {
        ...
        $admin_assets = new CDD_Admin_Assets( $this->get_plugin_name(), $this->get_version() );
    ...
    */
    private function define_public_asset_hooks() {
        ...
        $public_assets = new CDD_Public_Assets( $this->get_plugin_name(), $this->get_version() );
    ...
    */
    private function define_admin_module_hooks() {
        ...
        $module = new CDD_Admin_Module( $this->get_plugin_name(), $this->get_version() );
    ...
    */
    private function define_admin_module_ajax_hooks() {
        ...
        $module_ajax = new CDD_Admin_Module_Ajax( $this->get_plugin_name(), $this->get_version() );
    ...
    */
    private function define_public_module_hooks() {
        ...
        $module = new CDD_Public_Module( $this->get_plugin_name(), $this->get_version() );
    ...
    */
    private function define_public_module_ajax_hooks() {
        ...
        $module_ajax = new CDD_Public_Module_Ajax( $this->get_plugin_name(), $this->get_version() );
